...
public class CSTtoXMLConverter {
    ...
    public static boolean generateXMLFileVersion(CGrammarParser parser, ParseTree tree, String fileName) throws IOException {
        ParseTreeWalker.DEFAULT.walk(new CGrammarBaseListener() {
            final String INDENT = "    ";
            int level = 0;
